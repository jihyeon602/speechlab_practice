...
# Tacotron2
ckpt_dict = torch.load(r'C:\Users\302-26\sound_practice\torch-hybrid-tacotron2\acoustic.ckpt', map_location=torch.device(device))
model = Tacotron2()
model.load_state_dict(ckpt_dict['model'])
model = model.eval()

# Vocoder
ckpt_dict = torch.load(r'C:\Users\302-26\sound_practice\torch-hybrid-tacotron2\vocoder.ckpt', map_location=torch.device(device))
vocoder = WaveGlow()
